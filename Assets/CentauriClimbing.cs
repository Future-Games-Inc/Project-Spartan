...
namespace BNG
{
    public class CentauriClimbing : MonoBehaviour
    {
        ...
        public Vector3 previousLeftControllerPosition;
        public Vector3 previousRightControllerPosition;

        public Vector3 controllerMoveAmount;
