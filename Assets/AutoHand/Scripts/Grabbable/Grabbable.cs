...
namespace Autohand {
    ...
    public class Grabbable : GrabbableBase {
        ...
        [Tooltip("This will copy the given grabbables settings to this grabbable when applied"), NaughtyAttributes.OnValueChanged("EditorCopyGrabbable")]
        ...
        [NaughtyAttributes.ShowIf("singleHandOnly")]
        ...
        [NaughtyAttributes.DisableIf("instantGrab"), Tooltip("If true (and using HandToGrabbable) the hand will only return to the follow while moving. Good for picking up objects without disrupting the things around them - you can change the speed of the hand return on the hand through the gentleGrabSpeed value")]
