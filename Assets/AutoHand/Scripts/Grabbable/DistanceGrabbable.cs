...
namespace Autohand{
    ...
    public class DistanceGrabbable : MonoBehaviour{
        ...
        [NaughtyAttributes.ShowIf("grabType", DistanceGrabType.Velocity)]
        ...
        [NaughtyAttributes.EnableIf("ignoreHighlights"), Tooltip("Highlight targeted material to use - defaults to HandPointGrab materials if none")]
        public Material targetedMaterial;
        [NaughtyAttributes.EnableIf("ignoreHighlights"), Tooltip("Highlight selected material to use - defaults to HandPointGrab materials if none")]
