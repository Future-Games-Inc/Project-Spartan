...
namespace Autohand {
    ...
    public class HandDistanceGrabber : MonoBehaviour {
        ...
        [NaughtyAttributes.ShowIf("showEvents"), Tooltip("Targeting is started when object is highlighted")]
