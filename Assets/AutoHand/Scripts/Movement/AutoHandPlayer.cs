...
namespace Autohand {
    ...
    public class AutoHandPlayer : MonoBehaviour {
        ...
        [NaughtyAttributes.EnableIf("useMovement"), FormerlySerializedAs("moveSpeed")]
        [Tooltip("Movement speed when isGrounded")]
        public float maxMoveSpeed = 1.5f;
        [NaughtyAttributes.EnableIf("useMovement")]
        ...
        [NaughtyAttributes.ShowIf("showHeight"), Tooltip("Smooths camera upward movement when stepping up")]
        public float heightSmoothSpeed = 20f;
        [NaughtyAttributes.ShowIf("showHeight")]
        ...
        [NaughtyAttributes.EnableIf("useGrounding"), Tooltip("Maximum height that the body can step up onto"), Min(0)]
        public float maxStepHeight = 0.3f;
        [NaughtyAttributes.EnableIf("useGrounding"), Tooltip("Maximum angle the player can walk on"), Min(0)]
        public float maxStepAngle = 30f;
        [NaughtyAttributes.EnableIf("useGrounding"), Tooltip("The layers that count as ground")]
        public LayerMask groundLayerMask;
        [NaughtyAttributes.EnableIf("useGrounding"), Tooltip("Movement acceleration when isGrounded")]
        ...
        [NaughtyAttributes.ShowIf("allowClimbing")]
        ...
        [Tooltip("How quickly the player can climb")]
        [NaughtyAttributes.EnableIf("allowBodyPushing")]
        ...
        [NaughtyAttributes.EnableIf("useGrounding"), Tooltip("The layers that platforming will be enabled on, will not work with layers that the HandPlayer can't collide with")]
